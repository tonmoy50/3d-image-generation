...
def generate_gt_mv_img(mesh_path):
    ...
    for view, R in angles.items():
        ...
        plt.imsave(f"outputs/{view}.png", rgb_image)
...
if __name__ == "__main__":
    mesh_path = "model.obj"  # Replace with your mesh file path
    # show_mesh(mesh_path)  # Optional: Show the mesh
    # render_rgb_from_mesh(mesh_path)  # Render and save the RGB image
    generate_gt_mv_img(mesh_path)  # Generate GT multi-view image
