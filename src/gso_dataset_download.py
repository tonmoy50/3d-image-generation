...
if sys.version_info[0] < 3:
    raise Exception(
        "Python 3 or greater is required. Try running `python3 download_collection.py`"
    )
...
while True:
    ...
    page = page + 1
    next_url = "/models?page={}&per_page=100&q=collections:{}".format(
    ...
    for model in models:
        ...
        with open(
            os.path.join("/nobackup/nhaldert/data/GSO", model_name + ".zip"), "wb"
        ) as fd:
